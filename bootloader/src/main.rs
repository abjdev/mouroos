...
fn bootloader_main(
    ...
    {
        use core::fmt::Write;
        let _ = write!(printer::Printer, "Mouros 64-Bit Bootloader v1.0\n");
        let _ = write!(printer::Printer, "Loading Mouros kernel into memory...\n");
    }
    ...
    {
        use core::fmt::Write;
        let _ = write!(printer::Printer, "Transferring control to Mouros kernel...\n");
    }
