...
_start:
    jmp start_code
    .space 6, 0 # pad to offset 8
bi_pvd:           .long 0
bi_boot_file_lba: .long 0
bi_boot_file_len: .long 0
bi_checksum:      .long 0
...
start_code:
    ...
    # save BIOS boot drive at safe location away from stack
    mov byte ptr [0x7000], dl
...
unreal_mode:
    ...
    # check if stage 2 is already loaded in memory (e.g. by El Torito BIOS boot-load-size)
    cmp word ptr [_rest_of_bootloader_start_addr], 0x3166
    je jump_to_second_stage
...
boot_start_str: .asciz "Mouros Bootloader v1.0 (Stage 1)"
error_str: .asciz "Mouros Boot Error: "
no_int13h_extensions_str: .asciz "No int13h extensions supported"
rest_of_bootloader_load_failed_str: .asciz "Failed to load Mouros Stage 2"
...
.global dap
.global dap_blocks
.global dap_buffer_addr
.global dap_buffer_seg
.global dap_start_lba
